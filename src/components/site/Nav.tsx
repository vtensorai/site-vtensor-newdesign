    ...
    <header className="sticky top-0 z-50 bg-paper/95 backdrop-blur border-b border-rule" style={{ background: "color-mix(in srgb, var(--bg) 92%, transparent)" }}>
      <div className="container flex items-center justify-between gap-6 py-4 lg:py-5">
        ...
        <div className="flex items-center gap-3 lg:gap-5">
          ...
          <button
            type="button"
            className="lg:hidden inline-flex items-center justify-center w-10 h-10 border border-rule text-ink hover:border-ink transition-colors cursor-pointer"
      ...
      {open && (
        <div className="lg:hidden border-t border-rule bg-paper" style={{ background: "var(--bg)" }}>

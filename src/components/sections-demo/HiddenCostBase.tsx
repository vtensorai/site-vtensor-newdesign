      ...
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="flex flex-col items-center gap-3 mb-12">
          ...
          <img
            ...
            draggable={false}
          />
          <div className="text-[11px] uppercase tracking-[0.22em] text-[#22D3EE] font-semibold mb-1">
            // ce que vous vivez
          </div>
          <h2
  ...
  return (
    ...
    >
      ...
      <img
        ...
        draggable={false}
      />
      <div className="text-[11px] uppercase tracking-[0.22em] text-[#22D3EE] font-semibold mt-1">
        // ce que vous vivez
      </div>
      <h2
